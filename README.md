...
* [rfiris.ipynb](https://github.com/efurlanm/ml/blob/master/rfiris.ipynb) - Notebook based on *Understanding Random Forests Classifiers in Python* by Avinash Navlani, 2018
