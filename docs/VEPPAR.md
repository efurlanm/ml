...
The present application is command line based, MPI-enabled, and if **statically linked** can be deployed to any system in the grid, or any system with **MPICH** support <sup>[[1]](#1)</sup> , if MPI execution is desired.

*Last Updated ( Friday, 09 May 2008 )*

---
<span id="1"><sup>[1]</sup></span> According to the Makefile, the original code is compiled using Intel Fortran 8.0. The Intel package brings the MPI library based on the MPICH specification.